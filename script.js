...
console.log('%c🔗 Репозиторий: https://github.com/[kamimi75]/[visiting-card]', 'color: #2c3e50; font-size: 14px;');
console.log('%c🌐 Сайт: https://[kamimi75].github.io/[visiting-card]/', 'color: #3498db; font-size: 14px;');
